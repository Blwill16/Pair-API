...
CREATE TABLE IF NOT EXISTS pairing_history (
    ...
    recommended_track_id UUID NOT NULL REFERENCES pair_tracks(id) ON DELETE CASCADE,
    mode TEXT,
    slot_type TEXT,
    slot_position INT,
...
-- Public read for genres and track features
...
-- Check if user should receive weekly drop (based on timezone)
